...
const Requests = () => {
  ...
  const reviewRequests = useCallback(async (status, _id) => {
    if (processingIds.has(_id)) return;
  ...
  }, [dispatch, processingIds]);

  const fetchRequests = useCallback(async () => {
    if (fetchingRequests) return;
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-3 ml-4">
                    <button 
                      ...
                      disabled={processingIds.has(_id)}
                      className={`font-medium px-6 py-2 rounded-lg transition-colors duration-200 shadow-md flex items-center justify-center ${
                        processingIds.has(_id) 
