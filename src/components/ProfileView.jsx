...
const ProfileView = () => {
  ...
  if (loading) {
    return (
      <div className="flex bg-base-200 justify-center items-center min-h-screen">
  ...
  return (
    <div className="min-h-screen p-4 flex justify-center items-center bg-center bg-cover"
    
      style={{ backgroundImage: "url('/sky3.jpg')" }}>
      
      <div className="w-full max-w-4xl">
        <div className="shadow-xl">
          <div className="card bg-base-200 text-gray-900 dark:text-gray-100">
