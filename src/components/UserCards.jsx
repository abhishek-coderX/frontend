        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden  w-80 mx-auto transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="p-6">
            ...
            <div className="flex justify-center items-center space-x-8 mt-4">
              <button className="flex items-center justify-center px-6 py-3 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors duration-200">
                <X className="w-5 h-5 text-gray-600 mr-2" strokeWidth={2} />
                <span className="text-gray-700 font-medium" onClick={()=>handleRequest("ignored",_id)}>Ignore</span>
              </button>

              <button className="flex items-center justify-center px-6 py-3 bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 rounded-full transition-all duration-200">
